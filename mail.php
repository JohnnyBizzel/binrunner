...
function mails($email1,$firstname,$lastname,$random,$listid) {
...
$mail = new PHPMailer;
  ...
  $mail->WordWrap = 50;                                 
  $mail->isHTML(true);                                  
  $mail->Subject = 'Binrunner Activation of Account';
  $mail->Body    = "Hello $firstname $lastname, \n\n <b>Please click on the link below</b> \n http://110.174.90.188:81/david/BinRunner/active.php?id=$listid&code=$random";
